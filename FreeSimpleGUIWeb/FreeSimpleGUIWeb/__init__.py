        ...
        if hasattr(app, 'websockets'):
            app.execute_javascript(
                ...
                % {
                    ...
                    'content': self.Widget.get_value(),
                    'autoscroll': 'true' if autoscroll else 'false',
                }
            )
...
class Graph(Element):
    ...
    def DrawRectangle(self, top_left, bottom_right, fill_color=None, line_color='black'):
        ...
        rpoint = remi.gui.SvgRectangle(
            converted_top_left[0],
            converted_top_left[1],
            abs(converted_bottom_right[0] - converted_top_left[0]),
            abs(converted_top_left[1] - converted_bottom_right[1]),
        )
    ...
    def remi_thread(self):
        ...
        try:
            remi.start(
                ...
                update_interval=self.web_update_interval,
                userdata=(self,),
            )
    ...
    class MyApp(remi.App):
        def __init__(self, *args, userdata2=None):
            ...
            if userdata2 is None:
                ...
                super(Window.MyApp, self).__init__(
                    *args,
                    static_file_path={
                        'C': 'c:',
                        'c': 'c:',
    ...
    for row_num, flex_row in enumerate(form.Rows):
        ...
        for col_num, element in enumerate(flex_row):
            ...
            # -------------------------  TabGroup element  ------------------------- #
                ...
                element.Widget = remi.gui.Slider(
                    layout_orientation=orient,
            ...
            # -------------------------  TABLE element  ------------------------- #
                ...
                for row_num, row in enumerate(element.Values):  # convert entire table to strings
                    ...
                    if element.DisplayRowNumbers:
                        new_row = [
                            element.RowHeaderText if row_num == 0 else str(row_num + element.StartingRowNumber),
                        ] + new_row
...
def setup_remi_window(app: Window.MyApp, window: Window):
    ...
    if not window.DisableClose:
        ...
        tag.add_child(
            'javascript',
            """window.onunload=function(e){sendCallback('%s','%s');return "close?";};""" % (str(id(app)), 'on_window_close'),
        )
...
def main():
    ...
    menu_def = [
        ['File', ['&Open::mykey', '&Save', 'E&xit', 'Properties']],
        [
            'Edit',
            [
                '!Paste',
    ...
    layout = [
        ...
        [
            Text(
                'PySimpleGUIWeb Welcomes You...',
                tooltip='text',
                font=('Comic sans ms', 20),
                size=(40, 1),
                text_color='yellow',
                enable_events=False,
                key='_PySimpleGUIWeb_',
            )
        ],
        # [OptionMenu([])],
        ...
        [
            T('Current Time '),
            Text('Text', key='_TEXT_', font='Arial 18', text_color='black', size=(30, 1)),
            Column(col1, background_color='red'),
        ],
        ...
        [
            Checkbox('Checkbox 1', enable_events=True, key='_CB1_'),
            Checkbox('Checkbox 2', default=True, key='_CB2_', enable_events=True),
        ],
        [
            Combo(
        ...
        [
            OK(),
            Button('Hidden', visible=False, key='_HIDDEN_'),
            Button('Values'),
            Button('Exit', button_color=('white', 'red')),
            Button('UnHide'),
            B('Popup'),
        ],
    ]
    ...
    window = Window(
        'PySimpleGUIWeb Test Harness Window',
        layout,
        font='Arial 18',
        icon=DEFAULT_BASE64_ICON,
